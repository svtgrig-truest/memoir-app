...
const EXTRACT_PROMPT =
  'Это частный семейный архив. Составь подробный биографический указатель документа. ' +
  'Перечисли в виде структурированного списка фактов:\n' +
  '• Все упомянутые люди: имя, годы жизни, кем приходятся друг другу\n' +
  '• Все события: дата, место, участники\n' +
  '• Награды, должности, организации\n' +
  '• Географические места\n' +
  'Не пропускай ни одного имени или даты. Пиши только фактическую информацию из документа.';
