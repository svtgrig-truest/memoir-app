...
const EXTRACT_PROMPT =
  'Это частный семейный архивный документ. Твоя задача — создать подробный биографический экстракт. ' +
  'Перечисли: (1) всех упомянутых людей с датами жизни и родственными связями; ' +
  '(2) все события с датами и местами; (3) все награды и достижения; ' +
  '(4) все упомянутые организации и должности; (5) любые другие факты о семье. ' +
  'Будь максимально детальным — не пропускай ни одного имени, даты или события.';
