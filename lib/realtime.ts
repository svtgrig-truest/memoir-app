...
export function buildSystemPrompt(opts: SystemPromptOptions): string {
  ...
  if (chapterTitle) {
    ...
    greetingSection = `\n\nПОРЯДОК НАЧАЛА: Сразу начни беседу сам — не жди, когда заговорит собеседник. Поздоровайся: «Здравствуйте, Александр Григорьевич». Скажи, что рад познакомиться и что вы начинаете записывать историю его жизни с самого начала. Задай один мягкий открытый вопрос о самом раннем детстве — например, о первых воспоминаниях, о доме где рос, о родителях. Один вопрос — и жди.`;
  } else {
